...
do_install () {
    ...
    install -m 0644 ${UNPACKDIR}/tn-u-boot-fw-env.service ${D}${systemd_unitdir}/system/tn-u-boot-fw-env.service
    install -d ${D}${sbindir}
    install -m 0755 ${UNPACKDIR}/tn-u-boot-fw-env.sh ${D}${sbindir}
}
